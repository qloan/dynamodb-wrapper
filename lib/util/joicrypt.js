...
extendedJoi.validate = (value, schema, options, cb) => {
    ...
    _encryptedFields  = [];
    console.log('&&&&about to empty _compressedFields here ', _compressedFields);
    _compressedFields = [];
    console.log('&&&&emptied _compressedFields here ', _compressedFields);
    ...
    console.log('&&&&returning result.compressedFields', result.compressedFields);
